...
export const UserHome = () => {
    const currStep = useSelector((state: RootState) => state.operation.currentStep)
    const elementKey = useGetInitialComponent()
    const CurrentComponent = elementKey && ComponentMap[elementKey]

    return <div className="p-4 rounded-md bg-neutral-600 inset-shadow-lg inset-shadow-green-600 min-w-lg">
